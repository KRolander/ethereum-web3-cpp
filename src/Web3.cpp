...
//
//   The Web3 class is used to RPC format, last step before sending 
//   the transaction to the Ethereum RPC interface
//
...
string Web3::EthSendSignedTransaction(const string* data, const uint32_t dataLen) {
    ...
    std::cout << "TODO in EthSendSignedTransaction" << std::endl;
    return input;
}
